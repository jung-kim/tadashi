...
const _eventSignalsFunc = require('../../../../js/singletons/viewcontrols/stream');
const chattersTableVC = require('../../../../js/singletons/viewcontrols/stream/chattersTableVC');
const dateTimeRangeVC = require('../../../../js/singletons/viewcontrols/stream/dateTimeRangeVC');
const navOptionVC = require('../../../../js/singletons/viewcontrols/stream/navOptionVC');
const twitchEmbededVC = require('../../../../js/singletons/viewcontrols/stream/twitchEmbededVC');
