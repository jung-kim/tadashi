module.exports = Object.freeze({
    ...
    CHART_LABEL: ["chat", "re-subscription", "cheer", "subscription", "ban", "anonymous gift", "subscription gift", "subscription mystery", "timeout"],
    CHART_BACKGROUND_COLOR: [
        "rgb(255, 255, 0, 0.3)",   // yellow
        "rgb(153, 255, 51, 0.3)",  // yellow green
        "rgb(51, 255, 255, 0.3)",  // sky blue
        "rgb(0, 128, 225, 0.3)",   // navy blue
        "rgb(255, 51, 153, 0.3)",  // pink
        "rgb(102, 0, 204, 0.3)",   // purple
        "rgb(255, 128, 0, 0.3)",   // orange
        "rgb(128, 128, 128, 0.3)", // grey
        "rgb(0, 225, 139, 0.3)"
    ],
    CHART_BORDER_COLOR: [
        "rgb(255, 255, 0, 1.0)",   // yellow
        "rgb(153, 255, 51, 1.0)",  // yellow green
        "rgb(51, 255, 255, 1.0)",  // sky blue
        "rgb(0, 128, 225, 1.0)",   // navy blue
        "rgb(255, 51, 153, 1.0)",  // pink
        "rgb(102, 0, 204, 1.0)",   // purple
        "rgb(255, 128, 0, 1.0)",   // orange
